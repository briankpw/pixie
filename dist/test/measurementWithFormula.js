...
describe('Measurement With Formula- @getPixie Function Test', function () {
    ...
    it('PMATH.SUM', function () {
        ...
        var totalMath = [new PMath('firstPass', PMATH.SUM), new PMath('rework', PMATH.SUM), new PMath('failed', PMATH.NONE)];
    ...
    it('PMATH.SUBTRACT', function () {
        var dimension = new Dimension('date', TYPE.DATE);
        var subMath = [new PMath('firstPass', PMATH.SUBTRACT), new PMath('rework', PMATH.SUBTRACT), new PMath('failed', PMATH.NONE)];
        var dimensionList = [new Dimension('projectId', TYPE.ANY)];
    ...
    it('PMATH.MULTIPLE', function () {
        var dimension = new Dimension('date', TYPE.DATE);
        var multiMath = [new PMath('firstPass', PMATH.MULTIPLE), new PMath('rework', PMATH.MULTIPLE), new PMath('failed', PMATH.NONE)];
        var dimensionList = [new Dimension('projectId', TYPE.ANY)];
    ...
    it('PMATH.DIVIDE', function () {
        var dimension = new Dimension('date', TYPE.DATE);
        var divideMath = [new PMath('firstPass', PMATH.DIVIDE), new PMath('failed', PMATH.NONE)];
        var dimensionList = [new Dimension('projectId', TYPE.ANY)];
